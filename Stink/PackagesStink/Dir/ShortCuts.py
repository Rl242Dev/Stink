...
print('Hey welcome to ShortCuts, if you haven\'t set up ShortCuts already then go to the Githup Page to see (In the wiki page) | https://github.com/Rl242Dev/Stink |')
